...
public class Deck implements ActionListener {
    ...
    private ImageIcon actinoliteImage = new ImageIcon(getClass().getResource("/CardImages/Actinolite.png"));
    private JButton actinolite = new JButton(actinoliteImage);
    private ImageIcon andalusiteImage = new ImageIcon(getClass().getResource("/CardImages/Andalusite.png"));
    private JButton andalusite = new JButton(andalusiteImage);
    private ImageIcon antigoriteImage = new ImageIcon(getClass().getResource("/CardImages/Antigorite.png"));
    private JButton antigorite = new JButton(antigoriteImage);
    private ImageIcon apatiteImage = new ImageIcon(getClass().getResource("/CardImages/Apatite.png"));
    private JButton apatite = new JButton(apatiteImage);
    private ImageIcon augiteImage = new ImageIcon(getClass().getResource("/CardImages/Augite.png"));
    private JButton augite = new JButton(augiteImage);
    private ImageIcon bariteImage = new ImageIcon(getClass().getResource("/CardImages/Barite.png"));
    private JButton barite = new JButton(bariteImage);
    private ImageIcon berylImage = new ImageIcon(getClass().getResource("/CardImages/Beryl.png"));
    private JButton beryl = new JButton(berylImage);
    private ImageIcon biotiteImage = new ImageIcon(getClass().getResource("/CardImages/Biotite.png"));
    private JButton biotite = new JButton(biotiteImage);
    private ImageIcon calciteImage = new ImageIcon(getClass().getResource("/CardImages/Calcite.png"));
    private JButton calcite = new JButton(calciteImage);
    private ImageIcon cassiteriteImage = new ImageIcon(getClass().getResource("/CardImages/Cassiterite.png"));
    private JButton cassiterite = new JButton(cassiteriteImage);
    private ImageIcon chalcopyriteImage = new ImageIcon(getClass().getResource("/CardImages/Chalcopyrite.png"));
    private JButton chalcopyrite = new JButton(chalcopyriteImage);
    private ImageIcon chloriteImage = new ImageIcon(getClass().getResource("/CardImages/Chlorite.png"));
    private JButton chlorite = new JButton(chloriteImage);
    private ImageIcon chromiteImage = new ImageIcon(getClass().getResource("/CardImages/Chromite.png"));
    private JButton chromite = new JButton(chromiteImage);
    private ImageIcon corundumImage = new ImageIcon(getClass().getResource("/CardImages/Corundum.png"));
    private JButton corundum = new JButton(corundumImage);
    private ImageIcon diamondImage = new ImageIcon(getClass().getResource("/CardImages/Diamond.png"));
    private JButton diamond = new JButton(diamondImage);
    private ImageIcon dolomiteImage = new ImageIcon(getClass().getResource("/CardImages/Dolomite.png"));
    private JButton dolomite = new JButton(dolomiteImage);
    private ImageIcon epidoteImage = new ImageIcon(getClass().getResource("/CardImages/Epidote.png"));
    private JButton epidote = new JButton(epidoteImage);
    private ImageIcon fluoriteImage = new ImageIcon(getClass().getResource("/CardImages/Fluorite.png"));
    private JButton fluorite = new JButton(fluoriteImage);
    private ImageIcon galenaImage = new ImageIcon(getClass().getResource("/CardImages/Galena.png"));
    private JButton galena= new JButton(galenaImage);
    private ImageIcon garnetImage = new ImageIcon(getClass().getResource("/CardImages/Garnet.png"));
    private JButton garnet = new JButton(garnetImage);
    private ImageIcon geothiteImage = new ImageIcon(getClass().getResource("/CardImages/Geothite.png"));
    private JButton geothite = new JButton(geothiteImage);
    private ImageIcon gibbsiteImage = new ImageIcon(getClass().getResource("/CardImages/Gibbsite.png"));
    private JButton gibbsite = new JButton(gibbsiteImage);
    private ImageIcon glaucophaneImage = new ImageIcon(getClass().getResource("/CardImages/Glaucophane.png"));
    private JButton glaucophane = new JButton(glaucophaneImage);
    private ImageIcon goldImage = new ImageIcon(getClass().getResource("/CardImages/Gold.png"));
    private JButton gold = new JButton(goldImage);
    private ImageIcon graphiteImage = new ImageIcon(getClass().getResource("/CardImages/Graphite.png"));
    private JButton graphite = new JButton(graphiteImage);
    private ImageIcon gypsumImage = new ImageIcon(getClass().getResource("/CardImages/Gypsum.png"));
    private JButton gypsum = new JButton(gypsumImage);
    private ImageIcon haliteImage = new ImageIcon(getClass().getResource("/CardImages/Halite.png"));
    private JButton halite = new JButton(haliteImage);
    private ImageIcon hematiteImage = new ImageIcon(getClass().getResource("/CardImages/Hematite.png"));
    private JButton hematite = new JButton(hematiteImage);
    private ImageIcon horneblendeImage = new ImageIcon(getClass().getResource("/CardImages/Horneblende.png"));
    private JButton horneblende = new JButton(horneblendeImage);
    private ImageIcon ilmeniteImage = new ImageIcon(getClass().getResource("/CardImages/Ilmenite.png"));
    private JButton ilmenite= new JButton(ilmeniteImage);
    private ImageIcon kaoliniteImage = new ImageIcon(getClass().getResource("/CardImages/Kaolinite.png"));
    private JButton kaolinite = new JButton(kaoliniteImage);
    private ImageIcon kyaniteImage = new ImageIcon(getClass().getResource("/CardImages/Kyanite.png"));
    private JButton kyanite = new JButton(kyaniteImage);
    private ImageIcon magnesiteImage = new ImageIcon(getClass().getResource("/CardImages/Magnesite.png"));
    private JButton magnesite = new JButton(magnesiteImage);
    private ImageIcon magnetiteImage = new ImageIcon(getClass().getResource("/CardImages/Magnetite.png"));
    private JButton magnetite = new JButton(magnetiteImage);
    private ImageIcon molybdeniteImage = new ImageIcon(getClass().getResource("/CardImages/Molybdenite.png"));
    private JButton molybdenite = new JButton(molybdeniteImage);
    private ImageIcon monaziteImage = new ImageIcon(getClass().getResource("/CardImages/Monazite.png"));
    private JButton monazite = new JButton(monaziteImage);
    private ImageIcon muscoviteImage = new ImageIcon(getClass().getResource("/CardImages/Muscovite.png"));
    private JButton muscovite = new JButton(muscoviteImage);
    private ImageIcon olivineImage = new ImageIcon(getClass().getResource("/CardImages/Olivine.png"));
    private JButton olivine = new JButton(olivineImage);
    private ImageIcon orthoclaseImage = new ImageIcon(getClass().getResource("/CardImages/Orthoclase.png"));
    private JButton orthoclase = new JButton(orthoclaseImage);
    private ImageIcon orthopyroxeneImage = new ImageIcon(getClass().getResource("/CardImages/Orthopyroxene.png"));
    private JButton orthopyroxene = new JButton(orthopyroxeneImage);
    private ImageIcon plagioclaseImage = new ImageIcon(getClass().getResource("/CardImages/Plagioclase.png"));
    private JButton plagioclase = new JButton(plagioclaseImage);
    private ImageIcon pyriteImage = new ImageIcon(getClass().getResource("/CardImages/Pyrite.png"));
    private JButton pyrite = new JButton(pyriteImage);
    private ImageIcon pyrrhotiteImage = new ImageIcon(getClass().getResource("/CardImages/Pyrrhotite.png"));
    private JButton pyrrhotite = new JButton(pyrrhotiteImage);
    private ImageIcon quartzImage = new ImageIcon(getClass().getResource("/CardImages/Quartz.png"));
    private JButton quartz = new JButton(quartzImage);
    private ImageIcon rutileImage = new ImageIcon(getClass().getResource("/CardImages/Rutile.png"));
    private JButton rutile = new JButton(rutileImage);
    private ImageIcon sideriteImage = new ImageIcon(getClass().getResource("/CardImages/Siderite.png"));
    private JButton siderite = new JButton(sideriteImage);
    private ImageIcon sillimaniteImage = new ImageIcon(getClass().getResource("/CardImages/Sillimanite.png"));
    private JButton sillimanite = new JButton(sillimaniteImage);
    private ImageIcon sphaleriteImage = new ImageIcon(getClass().getResource("/CardImages/Sphalerite.png"));
    private JButton sphalerite = new JButton(sphaleriteImage);
    private ImageIcon stauroliteImage = new ImageIcon(getClass().getResource("/CardImages/Staurolite.png"));
    private JButton staurolite = new JButton(stauroliteImage);
    private ImageIcon talcImage = new ImageIcon(getClass().getResource("/CardImages/Talc.png"));
    private JButton talc = new JButton(talcImage);
    private ImageIcon the_gemmologistImage = new ImageIcon(getClass().getResource("/CardImages/The_Gemmologist.png"));
    private JButton the_gemmologist = new JButton(the_gemmologistImage);
    private ImageIcon the_geologistImage = new ImageIcon(getClass().getResource("/CardImages/The_Geologist.png"));
    private JButton the_geologist = new JButton(the_geologistImage);
    private ImageIcon the_geophysicistImage = new ImageIcon(getClass().getResource("/CardImages/The_Geophysicist.png"));
    private JButton the_geophysicist = new JButton(the_geophysicistImage);
    private ImageIcon the_minerImage = new ImageIcon(getClass().getResource("/CardImages/The_Miner.png"));
    private JButton the_miner = new JButton(the_minerImage);
    private ImageIcon the_mineralogistImage = new ImageIcon(getClass().getResource("/CardImages/The_Mineralogist.png"));
    private JButton the_mineralogist = new JButton(the_mineralogistImage);
    private ImageIcon the_petrologistImage = new ImageIcon(getClass().getResource("/CardImages/The_Petrologist.png"));
    private JButton the_petrologist = new JButton(the_petrologistImage);
    private ImageIcon titaniteImage = new ImageIcon(getClass().getResource("/CardImages/Titanite.png"));
    private JButton titanite = new JButton(titaniteImage);
    private ImageIcon topazImage = new ImageIcon(getClass().getResource("/CardImages/Topaz.png"));
    private JButton topaz = new JButton(topazImage);
    private ImageIcon tourmalineImage = new ImageIcon(getClass().getResource("/CardImages/Tourmaline.png"));
    private JButton tourmaline = new JButton(tourmalineImage);
    private ImageIcon zirconImage = new ImageIcon(getClass().getResource("/CardImages/Zircon.png"));
